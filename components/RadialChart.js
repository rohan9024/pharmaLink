...
const numberOfInstitutions = 240; 

const chartData = [
  { category: "Institutions", count: numberOfInstitutions, fill: "var(--color-institution)" },
]
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>Total Number of Institutions Added</CardTitle>
                  ...
                  if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                    return (
                      ...
                      >
                        ...
                        >
                          {numberOfInstitutions.toLocaleString()}
                        </tspan>
                        <tspan
                          x={viewBox.cx}
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        ...
        <div className="leading-none text-muted-foreground">
          Showing the total number of institutions added from January to December 2024
        </div>
      </CardFooter>
    </Card>
  )
