        ...
        <>
            ...
            <div class="flex flex-col justify-center items-center mt-36 space-y-10 ">
                ...
                <div className='flex justify-center items-center space-x-10'>
                    ...
                    <Link href="/institute-login" className='border border-gray-900 shadow-lg px-10 py-2 cursor-pointer hover:ease-in transition  hover:bg-gray-200'>
                        <h1 class={`${poppins.className} text-lg font-medium cursor-pointer  rounded-2xl
                        `}>Institute Login</h1>
                    </Link>
      
                    <Link href="/supplier-login" className='border border-gray-900 shadow-lg px-10 py-2 cursor-pointer hover:ease-in transition  hover:bg-gray-200'>
                        <h1 class={`${poppins.className} text-lg font-medium cursor-pointer  rounded-2xl
                        `}>Supplier Login</h1>
                    </Link>
